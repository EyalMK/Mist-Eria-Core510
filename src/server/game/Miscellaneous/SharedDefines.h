...
#define RACEMASK_ALL_PLAYABLE \
    ((1<<(RACE_HUMAN-1))   |(1<<(RACE_ORC-1))          |(1<<(RACE_DWARF-1))   | \
     ...
     (1<<(RACE_DRAENEI-1)) |(1<<(RACE_GOBLIN-1))       |(1<<(RACE_WORGEN-1))  | (1<<(RACE_PANDAREN-1)) | (1<<(RACE_PANDAREN_A-1)) | (1<<(RACE_PANDAREN_H-1)))

#define RACEMASK_ALLIANCE \
    ((1<<(RACE_HUMAN-1)) | (1<<(RACE_DWARF-1)) | (1<<(RACE_NIGHTELF-1)) | \
     (1<<(RACE_GNOME-1)) | (1<<(RACE_DRAENEI-1)) | (1<<(RACE_WORGEN-1)) | (1<<(RACE_PANDAREN-1)) | (1<<(RACE_PANDAREN_A-1)))

#define RACEMASK_HORDE \
    ((1<<(RACE_ORC-1)) | (1<<(RACE_UNDEAD_PLAYER-1)) | (1<<(RACE_TAUREN-1)) | \
     (1<<(RACE_TROLL-1)) | (1<<(RACE_BLOODELF-1)) | (1<<(RACE_GOBLIN-1)) | (1<<(RACE_PANDAREN-1)) | (1<<(RACE_PANDAREN_H-1)))
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_REMOVE_TALENT                      = 181, // 5.1.0a
...
enum SpellCastResult
{
	...
	SPELL_FAILED_CS_RIDING_REQUIREMENT          = 171,
	SPELL_FAILED_PANDA_RIDING_REQUIREMENT       = 172,
	SPELL_FAILED_NOT_IDLE                       = 173,
	SPELL_FAILED_NOT_INACTIVE                   = 174,
	SPELL_FAILED_PARTIAL_PLAYTIME               = 175,
	SPELL_FAILED_NO_PLAYTIME                    = 176,
	SPELL_FAILED_NOT_IN_BATTLEGROUND            = 177,
	SPELL_FAILED_NOT_IN_RAID_INSTANCE           = 178,
	SPELL_FAILED_ONLY_IN_ARENA                  = 179,
	SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE = 180,
	SPELL_FAILED_ON_USE_ENCHANT                 = 181,
	SPELL_FAILED_NOT_ON_GROUND                  = 182,
	SPELL_FAILED_CUSTOM_ERROR                   = 183,
	SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW         = 184,
	SPELL_FAILED_TOO_MANY_SOCKETS               = 185,
	SPELL_FAILED_INVALID_GLYPH                  = 186,
	SPELL_FAILED_UNIQUE_GLYPH                   = 187,
	SPELL_FAILED_GLYPH_SOCKET_LOCKED            = 188,
	SPELL_FAILED_NO_VALID_TARGETS               = 189,
	SPELL_FAILED_ITEM_AT_MAX_CHARGES            = 190,
	SPELL_FAILED_NOT_IN_BARBERSHOP              = 191,
	SPELL_FAILED_FISHING_TOO_LOW                = 192,
	SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW      = 193,
	SPELL_FAILED_SUMMON_PENDING                 = 194,
	SPELL_FAILED_MAX_SOCKETS                    = 195,
	SPELL_FAILED_PET_CAN_RENAME                 = 196,
	SPELL_FAILED_TARGET_CANNOT_BE_RESURRECTED   = 197,
	SPELL_FAILED_NO_ACTIONS                     = 198,
	SPELL_FAILED_CURRENCY_WEIGHT_MISMATCH       = 199,
	SPELL_FAILED_WEIGHT_NOT_ENOUGH              = 200,
	SPELL_FAILED_WEIGHT_TOO_MUCH                = 201,
	SPELL_FAILED_NO_VACANT_SEAT                 = 202,
	SPELL_FAILED_NO_LIQUID                      = 203,
	SPELL_FAILED_ONLY_NOT_SWIMMING              = 204,
	SPELL_FAILED_BY_NOT_MOVING                  = 205,
	SPELL_FAILED_IN_COMBAT_RES_LIMIT_REACHED    = 206,
	SPELL_FAILED_NOT_IN_ARENA                   = 207,
	SPELL_FAILED_TARGET_NOT_GROUNDED            = 208,
	SPELL_FAILED_EXCEEDED_WEEKLY_USAGE          = 209,
	SPELL_FAILED_NOT_IN_LFG_DUNGEON             = 210,
	SPELL_FAILED_BAD_TARGET_FILTER              = 211,
	SPELL_FAILED_NOT_ENOUGH_TARGETS             = 212,
	SPELL_FAILED_NO_SPEC                        = 213,
	SPELL_FAILED_CANT_ADD_BATTLE_PET            = 214,
	SPELL_FAILED_CANT_UPGRADE_BATTLE_PET        = 215,
	SPELL_FAILED_WRONG_BATTLE_PET_TYPE          = 216,
...
enum InvisibilityType
{
    ...
    INVISIBILITY_QUEST_7        =  7,
    INVISIBILITY_QUEST_8        =  8,
    INVISIBILITY_QUEST_9        =  9,
    INVISIBILITY_UNK10          = 10,
    INVISIBILITY_UNK11          = 11,
    INVISIBILITY_QUEST_12       = 12,
    INVISIBILITY_QUEST_13       = 13,
    INVISIBILITY_QUEST_14       = 14,
    INVISIBILITY_QUEST_15       = 15,
    INVISIBILITY_QUEST_16       = 16,
    INVISIBILITY_QUEST_17       = 17,
    INVISIBILITY_QUEST_18       = 18,
    INVISIBILITY_QUEST_19       = 19,
    INVISIBILITY_QUEST_20       = 20,
    INVISIBILITY_QUEST_21       = 21,
    INVISIBILITY_QUEST_22       = 22,
    INVISIBILITY_QUEST_23       = 23,
    INVISIBILITY_QUEST_24       = 24,
    INVISIBILITY_QUEST_25       = 25,
    INVISIBILITY_QUEST_26       = 26,
    INVISIBILITY_QUEST_27       = 27,
    INVISIBILITY_QUEST_28       = 28,
    INVISIBILITY_QUEST_29       = 29,
    INVISIBILITY_QUEST_30       = 30,
    INVISIBILITY_QUEST_31       = 31,
    INVISIBILITY_QUEST_32       = 32,
    INVISIBILITY_QUEST_33       = 33,
    INVISIBILITY_QUEST_34       = 34,
    INVISIBILITY_QUEST_35       = 35,
    INVISIBILITY_QUEST_36       = 36,
    INVISIBILITY_QUEST_37       = 37,
...
enum Targets
{
    ...
    TARGET_UNK_116                     = 116,
    TARGET_UNK_117                     = 117,
    TARGET_UNIT_RAID_CASTER2           = 118, // 5.1.0a
    TARGET_UNK_119                     = 119,
    TARGET_UNK_120                     = 120,
    TARGET_UNK_121                     = 121,
    TARGET_UNK_122                     = 122,
    ...
    TARGET_UNK_127                     = 127,
	TARGET_UNK_128                     = 128,
	TARGET_UNIT_ENNEMY_INLINE_FRONT    = 129,
	TARGET_UNK_130                     = 130,
	TARGET_UNK_131                     = 131,
	TARGET_UNK_132                     = 132,
	TARGET_UNK_133                     = 133,
...
enum HolidayIds
{
    ...
    HOLIDAY_CALL_TO_ARMS_WG          = 499,    // Call to Arms: Warsong Gulch
...
inline SkillType SkillByLockType(LockType locktype)
{
    switch (locktype)
    {
        //case LOCKTYPE_PICKLOCK:    return SKILL_LOCKPICKING;  //In mop SkillLine.dbc not have SKILL_LOCKPICKING
...
enum BattlegroundTypeId
{
    ...
    BATTLEGROUND_TK             = 699, // Temple of Kotmogu 5.x.x.
    BATTLEGROUND_CT             = 706, // CTF3              5.x.x
    BATTLEGROUND_SM             = 708, // Silvershard Mines 5.x.x
    BATTLEGROUND_TA             = 719  // Tol'Viron Arena   5.x.x
};
...
enum TradeStatus
{
    TRADE_STATUS_TARGET_TO_FAR = 0,
    TRADE_STATUS_YOU_LOGOUT = 1,
	TRADE_STATUS_YOU_STUNNED = 2,
	// 3 Non existent
	TRADE_STATUS_TRIAL_ACCOUNT = 4,
	TRADE_STATUS_TARGET_DEAD = 5,
	TRADE_STATUS_NO_TARGET = 6,
	TRADE_STATUS_TARGET_LOGOUT = 7,
	TRADE_STATUS_TARGET_STUNNED = 8,
	// 9 Non existent
	TRADE_STATUS_CURRENCY = 10,
	TRADE_STATUS_BUSY_2 = 11,
	TRADE_STATUS_PETITION = 12,
	TRADE_STATUS_BEGIN_TRADE = 13,
	TRADE_STATUS_BACK_TO_TRADE = 14,
	TRADE_STATUS_CURRENCY_NOT_TRADABLE = 15,
	TRADE_STATUS_UNACCEPTED = 16,
	TRADE_STATUS_TRADE_COMPLETE = 17,
	TRADE_STATUS_WRONG_REALM = 18,
	// 19 Non existent
	TRADE_STATUS_YOU_DEAD = 20,
	TRADE_STATUS_NOT_ON_TAPLIST = 21,
	TRADE_STATUS_TRADE_ACCEPT = 22,
	TRADE_STATUS_IGNORE_YOU = 23,
	// 24 Non existent
	TRADE_STATUS_TRADE_CANCELED = 25,
	TRADE_STATUS_CLOSE_WINDOW = 26,  
	// 27 Non existent
	TRADE_STATUS_WRONG_FACTION = 28,
	// 29 Non existent
	TRADE_STATUS_OPEN_WINDOW = 30,
	TRADE_STATUS_BUSY = 31,
};
...
enum BattlegroundQueueTypeId
{
	...
	BATTLEGROUND_QUEUE_TK		= 9,
	BATTLEGROUND_QUEUE_SM		= 10,
    BATTLEGROUND_QUEUE_RB       = 11,
    BATTLEGROUND_QUEUE_2v2      = 12,
    BATTLEGROUND_QUEUE_3v3      = 13,
    BATTLEGROUND_QUEUE_5v5      = 14,
