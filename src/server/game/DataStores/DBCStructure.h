...
struct ChrSpecializationEntry
{
    uint32 Id;                                              // 0
    //char* Icon                                            // 1
    uint32 ClassId;                                         // 2    0 = Pet
    uint32 MasterySpellId;                                  // 3
    //uint32  unknown                                       // 4    all 0
    uint32 TabId;                                           // 5    0 / 1 / 2 / 3
    uint32 PetTabId;                                        // 6    only for Pets values 0, 1, 2
    uint32 RoleTypeId;                                      // 7    0 = Tank / 1 = Heal / 2 = Damage
    //uint32                                                // 8
    //uint32                                                // 9
    //char*  Name;                                          // 10
    //char*  Description;                                   // 11
...
struct ChrSpecializationSpellsEntry
{
    uint32 Id;                                              // 0
    uint32 SpecId;                                          // 1
    uint32 SpellId;                                         // 2
    uint32 ReplaceSpellId;                                  // 3
    //uint32 unk;                                           // 4 only 0
};
...
{
        //uint32                                            // 0
        uint32 SpecId;                                      // 1    value is taken from ChrSpecialization.Id
        uint32 SpellId;                                     // 2
        uint32 SwitchSpellId;                               // 3
        //uint32                                            // 4    all 0
};
...
#define MAX_SPELL_EFFECTS_DIFFICULTY MAX_SPELL_EFFECTS*MAX_DIFFICULTY
#define MAX_SPELL_POWERS 3
#define MAX_EFFECT_MASK 2147483647
...
struct SpellPowerEntry
{
    ...
    uint32    powerCostPerSecond;                                // 7       m_manaPerSecond
