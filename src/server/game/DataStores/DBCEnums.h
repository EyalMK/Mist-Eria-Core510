...
enum AchievementCriteriaAdditionalCondition
{
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_UNK2                        = 2, //NYI
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_UNK16                       = 16, //NYI
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_UNK55                       = 55, // NYI
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_UNK60                       = 60, // NYI
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_PROJECT_RARITY              = 65, // NYI
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_PROJECT_RACE                = 66, // NYI
};
...
enum Difficulty
{
    ...
    RAID_DIFFICULTY_40MAN        = 9,
};

#define MAX_DUNGEON_DIFFICULTY     9 // Seems to be 9 : DUNGEON_DIFFICULTY_CHALLENGE = 8?
#define MAX_RAID_DIFFICULTY        10 // Seems like 40Man got a difficulty...
...
enum ItemEnchantmentType
{
	...
	ITEM_ENCHANTMENT_TYPE_SHA_SOCKET       = 9
};
...
enum SummonPropGroup
{
    ...
    SUMMON_PROP_GROUP_UNKNOWN4       = 5                    // 5.x.x.
};
