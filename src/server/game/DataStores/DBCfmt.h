...
char const SpellEntryfmt[]="nssxxiiixiiiiiiiiiiiiiixi";
...
char const SpellReagentsEntryfmt[]="niiiiiiiiiiiiiiiiii";
...
char const SpellPowerEntryfmt[]="niiiiiixxfxxx";
...
char const SpellCastingRequirementsEntryfmt[]="diixixi";
