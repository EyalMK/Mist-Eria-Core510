...
void LoadDB2Stores(const std::string& dataPath)
{
    ...
    if (!sItemStore.LookupEntry(93626)             ||       // last item added in 5.1.0 (16357)
        !sItemExtendedCostStore.LookupEntry(3872)  )        // last item extended cost added in 4.3.4 (15595) // don't know about this
    {
        sLog->outError(LOG_FILTER_GENERAL, "Please extract correct db2 files from client 5.1.0 16357.");
        exit(1);
    }
