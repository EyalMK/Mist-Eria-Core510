...
void WorldSession::HandleCharFactionOrRaceChange(WorldPacket& recvData)
{
    ...
    uint32 used_loginFlag = ((OpcodeRealValueToInternalEnum(PacketFilter::DropHighBytes(recvData.GetOpcode())) == CMSG_CHAR_RACE_CHANGE) ? AT_LOGIN_CHANGE_RACE : AT_LOGIN_CHANGE_FACTION);
