...
void WorldSession::HandleAreaTriggerOpcode(WorldPacket& recvData)
{
    uint32 triggerId;
    uint8  unk;
    recvData >> triggerId >> unk; //Fix for mop, not test yet
...
void WorldSession::HandleSetActionButtonOpcode(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_NETWORKIO, "CMSG_SET_ACTION_BUTTON slotId: %u actionId: %u", slotId, button->id);
...
=======
    ...
    delObj << uint8(0);
    SendPacket(&delObj);
>>>>>>> parent of bb50d11... Should fix PNJ visibility problem
}
