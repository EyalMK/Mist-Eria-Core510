...
pEffect SpellEffects[TOTAL_SPELL_EFFECTS] =
{
    ...
    &Spell::EffectNULL,                                     //168 SPELL_EFFECT_ALLOW_PET_CONTROL
    &Spell::EffectNULL,                                     //169 SPELL_EFFECT_DESTROY_ITEM
    &Spell::EffectNULL,                                     //170 SPELL_EFFECT_UPDATE_PLAYER_AURAS
    ...
    &Spell::EffectApplyAura,                                //174 SPELL_EFFECT_174
        ...
        case SPELLFAMILY_WARLOCK:
        {
			...
			switch (m_spellInfo->Id)
			{
				case 116858: // Chaos Bolt
					damage += int32(((m_caster->GetTotalSpellPowerValue(SPELL_SCHOOL_MASK_NORMAL, false) * 2.25f) * 1.24f) * (1 + (m_caster->ToPlayer()->GetRatingBonusValue(CR_CRIT_SPELL) / 100)));
					break;
