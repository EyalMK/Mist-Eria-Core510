...
class AuraApplication
{
    ...
    private:
        ...
        uint32 _effctsMask;                             // Aura info flag
    ...
    public:
        ...
        uint32 GetEffectMask() const { return _effctsMask; }
        bool HasEffect(uint8 effect) const { ASSERT(effect < MAX_SPELL_EFFECTS);  return _effctsMask & (1<<effect); }
...
class Aura
{
    ...
    public:
        ...
        static uint8 BuildEffectMaskForOwner(SpellInfo const* spellProto, uint32 avalibleEffectMask, WorldObject* owner);
