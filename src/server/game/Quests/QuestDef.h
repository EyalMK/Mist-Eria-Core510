...
{
    QUEST_REQUIREMENT_CREATURE = 0,
    QUEST_REQUIREMENT_ITEM = 1,
    QUEST_REQUIREMENT_GAMEOBJECT = 2,
    QUEST_REQUIREMENT_UNK3 = 3,
    QUEST_REQUIREMENT_CURRENCY = 4,
    QUEST_REQUIREMENT_SPELL = 5,
    QUEST_REQUIREMENT_FACTION = 6,
    QUEST_REQUIREMENT_UNK7 = 7,
    QUEST_REQUIREMENT_MONEY = 8,
    QUEST_REQUIREMENT_PLAYERSKILLS = 9,
    QUEST_REQUIREMENT_UNK10 = 10,
    QUEST_REQUIREMENT_UNK11 = 11
};
...
class Quest
{
    ...
    public:
		...
		uint32 GetFlags2() const { return Flags2; } // isn't done , it should something more in questdef.cpp as i remember
		uint32 GetQuestRequirementType() const { return requirement; }         // isn't done , it should something more in questdef.cpp as i remember
        ...
        uint32 GetRewardChoiceIdForEntry(uint32 rewardEntry) { return QUEST_REWARD_CHOICES_COUNT; }
