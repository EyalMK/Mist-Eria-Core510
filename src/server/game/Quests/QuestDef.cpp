...
Quest::Quest(Field* questRecord)
{
	...
	//Flags2 = questRecord[IDK].GetUint32();           // I don't know .. it should be a random record ?
	//requirement = questRecord[IDK].GetUint32();      // I don't know .. it should be a random record ?
