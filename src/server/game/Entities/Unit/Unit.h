...
enum ShapeshiftForm
{
    ...
    FORM_OXSTANCE           = 0x14, // 5.x.x - Monk   
    FORM_SERPENTSTANCE      = 0x17, // 5.x.x - Monk  
    FORM_TIGERSTANCE        = 0x18  // 5.x.x - Monk   
};
        ...
        */
        ...
        inline bool IsInDisallowedMountForm() const
        {
            ...
            return form != FORM_NONE && form != FORM_BATTLESTANCE && form != FORM_BERSERKERSTANCE && form != FORM_DEFENSIVESTANCE &&
                form != FORM_SHADOW && form != FORM_STEALTH && form != FORM_UNDEAD && form != FORM_SERPENTSTANCE && form != FORM_OXSTANCE && form != FORM_TIGERSTANCE;
        }
        ...
        int32 GetTotalSpellPowerValue(SpellSchoolMask mask, bool heal);
