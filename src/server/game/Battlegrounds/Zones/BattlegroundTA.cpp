...
{
    data << uint32(3601) << uint32(2);           // Gold
	data << uint32(3600) << uint32(2);           // Green
    UpdateArenaWorldState();
}
...
bool BattlegroundTA::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_TA_OBJECT_BUFF_1, BG_TA_OBJECT_TYPE_BUFF_1, 1328.719971f, 1632.719971f, 36.730400f, -1.448624f, 0, 0, 0.6626201f, -0.7489557f, 120)
        || !AddObject(BG_TA_OBJECT_BUFF_2, BG_TA_OBJECT_TYPE_BUFF_2, 1243.300049f, 1699.170044f, 34.872601f, -0.06981307f, 0, 0, 0.03489945f, -0.9993908f, 120))
    {
