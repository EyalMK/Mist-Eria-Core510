        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            for (SpellCooldowns::const_iterator itr = cm.begin(); itr != cm.end();)
            {
                ...
                if (spellInfo->SpellFamilyName == SPELLFAMILY_ROGUE)
                {
                    ...
                    //    sprint        vanish    cloak of shadows  evasion       dismantle
                    if (id == 2983 || id == 1856 || id == 31224 || id == 5277 || id == 51722 )
                                           ...
                                           void HandleBeforeHit()
{
                                           ...
                                           playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_WOUND);
                                           }
...
class spell_rog_poison_wound : public SpellScriptLoader
{
public:
    spell_rog_poison_wound() : SpellScriptLoader("spell_rog_poison_wound") { }

    class spell_rog_poison_wound_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_rog_poison_wound_SpellScript);

        void HandleBeforeHit()
        {
            if (Unit* caster = GetCaster())
                if (Player* playerCaster = caster->ToPlayer())
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_DEADLY);
        }

        void Register()
        {
            BeforeHit += SpellHitFn(spell_rog_poison_wound_SpellScript::HandleBeforeHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_rog_poison_wound_SpellScript();
    }
};

class spell_rog_poison_crippling : public SpellScriptLoader
{
public:
    spell_rog_poison_crippling() : SpellScriptLoader("spell_rog_poison_crippling") { }

    class spell_rog_poison_crippling_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_rog_poison_crippling_SpellScript);
        ...
        void HandleBeforeHit()
        {
            if (Unit* caster = GetCaster())
                if (Player* playerCaster = caster->ToPlayer())
                {
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_LEECHING);
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_MIND);
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_PARALYTIC);
                }
        }

        void Register()
        {
            BeforeHit += SpellHitFn(spell_rog_poison_crippling_SpellScript::HandleBeforeHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_rog_poison_crippling_SpellScript();
    }
};

class spell_rog_poison_leeching : public SpellScriptLoader
{
public:
    spell_rog_poison_leeching() : SpellScriptLoader("spell_rog_poison_leeching") { }

    class spell_rog_poison_leeching_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_rog_poison_leeching_SpellScript);
        ...
        void HandleBeforeHit()
        {
            if (Unit* caster = GetCaster())
                if (Player* playerCaster = caster->ToPlayer())
                {
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_CRIPPLING);
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_MIND);
                    playerCaster->RemoveAurasDueToSpell(SPELL_ROGUE_POISON_PARALYTIC);
                }
        }
        ...
        void Register()
        {
            BeforeHit += SpellHitFn(spell_rog_poison_leeching_SpellScript::HandleBeforeHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_rog_poison_leeching_SpellScript();
    }
};

class spell_rog_poison_mind : public SpellScriptLoader
{
public:
    spell_rog_poison_mind() : SpellScriptLoader("spell_rog_poison_mind") { }

    class spell_rog_poison_mind_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_rog_poison_mind_SpellScript);
        ...
        void Register()
        {
            BeforeHit += SpellHitFn(spell_rog_poison_mind_SpellScript::HandleBeforeHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_rog_poison_mind_SpellScript();
    }
};

class spell_rog_poison_paralytic : public SpellScriptLoader
{
public:
    spell_rog_poison_paralytic() : SpellScriptLoader("spell_rog_poison_paralytic") { }

    class spell_rog_poison_paralytic_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_rog_poison_paralytic_SpellScript);
        ...
        void Register()
        {
            BeforeHit += SpellHitFn(spell_rog_poison_paralytic_SpellScript::HandleBeforeHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_rog_poison_paralytic_SpellScript();
    }
};
...
void AddSC_rogue_spell_scripts()
{
    ...
    new spell_rog_deadly_poison();
    new spell_rog_poison_wound();
    new spell_rog_poison_crippling();
