...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_ACHIEVEMENTS, "SELECT achievement, date FROM character_achievement WHERE guid = ? UNION SELECT achievement, date FROM account_achievement WHERE account = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_SEL_CHARACTER_CRITERIAPROGRESS, "SELECT criteria, counter, date FROM character_achievement_progress WHERE guid = ? UNION SELECT criteria, counter, date FROM account_achievement_progress WHERE account = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_DEL_ACC_ACHIEVEMENT_BY_ACHIEVEMENT, "DELETE FROM account_achievement WHERE achievement = ? AND account = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_INS_ACC_ACHIEVEMENT, "INSERT INTO account_achievement (account, achievement, date) VALUES (?, ?, ?)", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_DEL_ACC_ACHIEVEMENT_PROGRESS_BY_CRITERIA, "DELETE FROM account_achievement_progress WHERE account = ? AND criteria = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_INS_ACC_ACHIEVEMENT_PROGRESS, "INSERT INTO account_achievement_progress (account, criteria, counter, date) VALUES (?, ?, ?, ?)", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_DEL_ACC_SPELL_BY_SPELL, "DELETE FROM account_spell WHERE spell = ? AND account = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_INS_ACC_SPELL, "INSERT INTO account_spell (account, spell, active, disabled) VALUES (?, ?, ?, ?)", CONNECTION_ASYNC);
